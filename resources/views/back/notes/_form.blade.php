...
<div class="form-group row">
    {{ Form::label('body', 'CONTENTS', ['class' => 'col-sm-2 col-form-label']) }}
    <div class="col-sm-10">
...
<div class="form-group row">
    {{ Form::label('is_public', 'STATUS', ['class' => 'col-sm-2 col-form-label']) }}
    <div class="col-sm-10">
        @foreach ([1 => '公開', 0 => '非公開'] as $key => $value)
            <div class="form-check form-check-inline">
                {{ Form::radio('is_public', $key, null, [
                    'id' => 'is_public'.$key,
                    'class' => 'form-check-input' . ($errors->has('is_public') ? ' is_invalid' : '')
                ]) }}
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        {{ Form::datetime('published_at',
            isset($note->published_at)
                ? $note->published_at->format('Y-m-d H:i')
